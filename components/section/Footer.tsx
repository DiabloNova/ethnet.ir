...
const navColumns = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'سیاست AML', href: '/documents' },
    ],
  },
]
...
export function Footer() {
  return (
    <footer
      ...
      style={{ backgroundColor: '#050a1a', borderColor: 'rgba(255,255,255,0.07)' }}
    >
      {/* Subtle top glow */}
      <div
        className="absolute top-0 left-1/2 -translate-x-1/2 w-1/2 h-px"
        style={{ background: 'linear-gradient(90deg, transparent, rgba(0,102,255,0.4), rgba(168,85,247,0.4), transparent)' }}
        aria-hidden="true"
      />
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="col-span-2 md:col-span-1">
            ...
            <p className="text-slate-500 text-sm leading-relaxed">
              پلتفرم سرمایه‌گذاری خرد امن در رمزنگاری با بهره‌گیری از DAO و فلش لن.
            </p>
          </motion.div>
        ...
        >
          ...
          <p className="text-slate-600 text-xs text-center sm:text-right">
            &copy; ۱۴۰۳ اتریوم نت. تمامی حقوق محفوظ است.
          </p>
          ...
          <div className="flex gap-2 w-full sm:w-auto">
            <input
              type="email"
              placeholder="خبرنامه — ایمیل شما"
              className="flex-1 sm:w-52 px-4 py-2 rounded-xl text-sm text-white placeholder-slate-600 focus:outline-none focus:ring-1 focus:ring-blue-500/40 transition-all"
              style={{ background: '#0d1a35', border: '1px solid rgba(255,255,255,0.08)' }}
            />
            <button
              className="px-4 py-2 rounded-xl text-sm font-bold text-white transition-all hover:opacity-90 whitespace-nowrap"
              style={{ background: 'linear-gradient(135deg, #0066ff, #a855f7)' }}
            >
              عضویت
            </button>
